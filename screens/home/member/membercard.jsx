...
export const MemberCard = ({name, age, distance, image, onPress}) => (
    <Container>  	
	<Card style={styles.cardStyle}>
	    <Image style={styles.imageStyle} source={{uri: image}}/>
	    <Button style={styles.floatingLikeButton}><Icon name="like" type="SimpleLineIcons" onPress={onPress} ></Icon></Button>
